...
│       ├── auth/            # 기능별: controller, service, dto, filter, principal, util
│       ├── user/            # controller(/api/auth/me), service, repository, entity, dto
│       ├── post/            # controller, service, repository, entity, dto
│       ├── health/          # controller
│       ├── common/          # 예외 처리, 공통 유틸
...
├── backend/TESTING.md       # 백엔드 테스트 실행·프로필·트러블슈팅
└── README.md                # 이 파일
```
